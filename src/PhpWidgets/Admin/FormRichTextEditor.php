  ...
  public function render() {
    ...
    <div class="form-row ">
          ...
          <div class="form-component">
              <div id="{$this->editorId}"  class="form-rte-field" ></div>
              <input type="hidden" id="{$this->editorId}-hidden" class="form-rte-field-hidden-element" name="{$this->name}" />
          </div>
      </div>
     $rteHtml 
HTML;
...
<script>
    (function() {
      ...
      function initFormRTE(containerEl, editorContent) {
          console.log(containerEl);
          if ($(containerEl).length === 0) {
              console.log("element not found " + containerEl);
              return;
          }
        ...
        class SmartBreak extends Break {
            ...
            insertInto(parent, ref) {
                BlockEmbed.prototype.insertInto.call(this, parent, ref);
            }
        }
        ...
        ScriptModule.blotName = 'script';
        ScriptModule.tagName = 'script';
        Quill.register(ScriptModule);
          ...
          var hiddenValueEl = $(containerEl).siblings(".form-rte-field-hidden-element:first");
      ...
      function initializeContent () {
        initFormRTE("#$elementId", "$value");
        $("#$elementId").parents('form').on('submit',  function(e) {
            if ($("#$elementId").siblings(".form-rte-field-hidden-element:first").length > 0) {
                $("#$elementId").siblings(".form-rte-field-hidden-element:first").val(document.querySelector("#$elementId").children[0].innerHTML);
            } else {
